...
For the shared Home / Module 2 / Module 3 application, run `streamlit run app.py`
from the repository root; see the [shared README](../README.md). The instructions
below launch Module 2 independently. From the repository root:
